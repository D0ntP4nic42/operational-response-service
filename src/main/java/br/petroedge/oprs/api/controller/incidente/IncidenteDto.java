...
public class IncidenteDto {
    ...
    public record BuscaIncidenteRequest(
        ...
        @Schema(
            description = "Status atual do incidente",
            example = "ABERTO"
        )
        IncidenteStatusEnum status,

        @Schema(
            description = "Importância atribuída ao incidente",
            example = "ALTA"
        )
        IncidenteImportanciaEnum importancia,

        @Schema(
            description = "Data inicial do período de criação",
            example = "2026-09-01T00:00:00"
        )
        LocalDateTime dtCriacaoInicio,

        @Schema(
            description = "Data final do período de criação"
        )
        LocalDateTime dtCriacaoFim,

        @Schema(
            description = "Data inicial do período de atualização"
        )
        LocalDateTime dtAtualizacaoInicio,

        @Schema(
            description = "Data final do período de atualização"
        )
    ...
    public record AdicionarIncidenteRequest(
        ...
        @Schema(
            description = "Título do incidente",
            example = "Temperatura elevada no motor"
        )
        String titulo,
        ...
        @Schema (
            description = "Indica se um e-mail deve ser enviado ao destinatário",
            example = "true"
        )
        boolean enviarEmail,
    ...
    public record BuscaIncidenteResponse(
        ...
        @Schema(
            description = "Importância do incidente",
            example = "ALTA"
        )
        IncidenteImportanciaEnum importancia,
